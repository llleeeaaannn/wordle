// All daily answers in order from Day 1
let validAnswers = [
...
// All accepted words in alphabetical order
let validWords = [
...
// Function to create and insert 5 tile div's into each row
function makeTiles() {
  for (i = 0; i < 6; i++) {
...
// Function to add each necessary key to each keyboard row with necessary attribute and event Listener
...
// Code to define the guessRows variable which is an array of 6 arrays each with 5 empty strings
...
function colorTiles() {
    ...
    guess.forEach((guess, index) => {
        thisLetter = guess.letter.toLowerCase();
...
function jump() {
  ...
  function jumpOne() {
    let jumpTileOne = document.getElementById('row' + currentRow + 'tile1');
    jumpTileOne.classList.toggle('jump')
  }

  function jumpTwo() {
    let jumpTileTwo = document.getElementById('row' + currentRow + 'tile2');
    jumpTileTwo.classList.toggle('jump')
  }

  function jumpThree() {
    let jumpTileThree = document.getElementById('row' + currentRow + 'tile3');
    jumpTileThree.classList.toggle('jump')
  }

  function jumpFour() {
    let jumpTileFour = document.getElementById('row' + currentRow + 'tile4');
    jumpTileFour.classList.toggle('jump')
  }
